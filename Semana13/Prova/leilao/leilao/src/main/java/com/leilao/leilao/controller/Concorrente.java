...
public class Concorrente {
	...
	public ResponseEntity<?> buscaConcorrente(@PathVariable Long id,
		...
		try {
			...
			com.leilao.leilao.model.Concorrente concorrente  = concorrenteRepository.getReferenceById(id);
	...
	public ResponseEntity<ConcorrenteDTO> inserir(@RequestBody ConcorrenteFORM concorrenteForm , UriComponentsBuilder uribuilder) {
		com.leilao.leilao.model.Concorrente concorrente = concorrenteForm.toConcorrente();
